...
type Point = any;
type EmbeddedFilesLoader = any;
type ColorMaster = any;
type TInput = any;
...
export declare function initExcalidrawAutomate(
  plugin: ExcalidrawPlugin
...
export declare const generatePlaceholderDataURL: (
  width: number,
  height: number
) => DataURL;
export declare function createPNG(
  templatePath: string,
  scale: number,
  exportSettings: ExportSettings,
  loader: EmbeddedFilesLoader,
...
export declare function createSVG(
  templatePath: string,
  embedFont: boolean,
  exportSettings: ExportSettings,
  loader: EmbeddedFilesLoader,
...
export declare function estimateBounds(
  elements: ExcalidrawElement[]
): [number, number, number, number];
export declare function repositionElementsToCursor(
  elements: ExcalidrawElement[],
  newPosition: {
    x: number;
    y: number;
 ...
 */
export declare const getTextElementsMatchingQuery: (
  elements: ExcalidrawElement[],
  query: string[],
  exactMatch?: boolean
) => ExcalidrawElement[];
 ...
 * @returns the elements matching the query
 */
export declare const getFrameElementsMatchingQuery: (
  elements: ExcalidrawElement[],
  query: string[],
  exactMatch?: boolean
) => ExcalidrawElement[];
export declare const cloneElement: (el: ExcalidrawElement) => any;
export declare const verifyMinimumPluginVersion: (
  requiredVersion: string
) => boolean;
export declare var ea: ExcalidrawAutomate;
